...
class Constants{
    ...
    struct EW {
        ...
        static let ewLightningInitialDelay: TimeInterval = 0.9
        static let ewLightningDelayMin: TimeInterval = 0.6
        static let ewLightningDelayMax: TimeInterval = 1.4
        static let ewLightningVisualTargetLimit = 3
        static let ewLightningVisualCandidateLimit = 4
        static let ewLightningTargetEndpointJitter: CGFloat = 10
        static let ewLightningOriginForwardOffsetMin: CGFloat = 10
        static let ewLightningOriginForwardOffsetMax: CGFloat = 15
        static let ewLightningOriginSideOffset: CGFloat = 5
        static let ewLightningSegmentTargetLength: CGFloat = 18
        static let ewLightningSegmentMin = 4
        static let ewLightningSegmentMax = 8
        static let ewLightningJitterMin: CGFloat = 7
        static let ewLightningJitterMax: CGFloat = 18
        static let ewLightningJitterDistanceRatio: CGFloat = 0.16
        static let ewLightningJitterMinFactor: CGFloat = 0.35
        static let ewLightningBranchLengthMin: CGFloat = 18
        static let ewLightningBranchLengthMax: CGFloat = 34
        static let ewLightningAttackBranchCountMin = 1
        static let ewLightningAttackBranchCountMax = 2
        static let ewLightningAmbientBranchCountMin = 0
        static let ewLightningAmbientBranchCountMax = 1
        static let ewLightningBranchAngleMin: CGFloat = 0.75
        static let ewLightningBranchAngleMax: CGFloat = 1.25
        static let ewLightningBranchMidpointOffsetFactor: CGFloat = 0.55
        static let ewLightningBranchMidpointJitter: CGFloat = 5
        static let ewLightningBranchWidthScale: CGFloat = 1.0
        static let ewLightningTerminalForkLengthMin: CGFloat = 11
        static let ewLightningTerminalForkLengthMax: CGFloat = 16
        static let ewLightningTerminalForkSplitAngleMin: CGFloat = 0.50
        static let ewLightningTerminalForkSplitAngleMax: CGFloat = 0.72
        static let ewLightningTerminalForkWidthScale: CGFloat = 1.0
        static let ewLightningOuterLineWidth: CGFloat = 3.2
        static let ewLightningOuterGlowWidth: CGFloat = 3.0
        static let ewLightningOuterLayerAlpha: CGFloat = 0.24
        static let ewLightningBodyLineWidth: CGFloat = 1.45
        static let ewLightningBodyGlowWidth: CGFloat = 1.2
        static let ewLightningBodyLayerAlpha: CGFloat = 0.82
        static let ewLightningCoreLineWidth: CGFloat = 0.65
        static let ewLightningCoreLayerAlpha: CGFloat = 1.0
        static let ewLightningMinArcLength: CGFloat = 8
        static let ewLightningJitterFlipThreshold: CGFloat = 0.62
        static let ewLightningDuration: TimeInterval = 0.16
        static let ewLightningAccentDuration: TimeInterval = 0.24
        static let ewLightningAccentSpriteAlpha: CGFloat = 1.0
        static let ewLightningFallbackGlowScale: CGFloat = 0.35
        static let ewLightningFallbackAccentAlpha: CGFloat = 0.75
        static let ewLightningFlickerInDuration: TimeInterval = 0.018
        static let ewLightningFlickerDimDuration: TimeInterval = 0.026
        static let ewLightningFlickerOutDuration: TimeInterval = 0.04
        static let ewLightningFlickerDimAlpha: CGFloat = 0.28
        static let ewLightningFlickerReturnAlpha: CGFloat = 0.96
        static let ewLightningFlickerMinHold: TimeInterval = 0.02
        static let ewLightningAmbientArcCountMin = 2
        static let ewLightningAmbientArcCountMax = 3
        static let ewLightningAmbientInnerRadiusMin: CGFloat = 9
        static let ewLightningAmbientInnerRadiusMax: CGFloat = 15
        static let ewLightningAmbientLengthMin: CGFloat = 50
        static let ewLightningAmbientLengthMax: CGFloat = 95
        static let ewLightningAmbientLengthRadiusRatio: CGFloat = 0.70
        static let ewLightningAmbientStartJitter: CGFloat = 4
        static let ewLightningAmbientEndJitter: CGFloat = 14
        static let ewLightningHitFlashSize = CGSize(width: 96, height: 96)
        static let ewLightningSparkClusterSize = CGSize(width: 34, height: 34)
        static let ewLightningEndpointPinchSize = CGSize(width: 4, height: 4)
        static let ewLightningEndpointStrokeCountMin = 3
        static let ewLightningEndpointStrokeCountMax = 5
        static let ewLightningEndpointStrokeLengthMin: CGFloat = 7
        static let ewLightningEndpointStrokeLengthMax: CGFloat = 14
        static let ewLightningEndpointOuterStrokeWidth: CGFloat = 2.4
        static let ewLightningEndpointCoreStrokeWidth: CGFloat = 0.9
        static let ewLightningEndpointSideOffset: CGFloat = 4.5
        static let ewLightningEndpointBackOffset: CGFloat = 4
        static let ewLightningEndpointStrokeSpread: CGFloat = 0.85
        // Player EW tower
